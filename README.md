...
For Codex / Codex CLI / Codex desktop, start with [`references/CODEX.md`](./references/CODEX.md). It maps the workflow's reviewer agents, checkpoints, shell commands, and validation steps onto Codex tools.
...
> Preview frames are from the upstream demo gallery. This repository keeps only the skill files needed for Codex installation.
...
- [CODEX.md](./references/CODEX.md) — Codex-specific tool mapping, checkpoints, Windows notes, and validation
